...
def load_data():
    ...
    while k<len(y_train):
      ...
      X_fin=np.concatenate((x_train[k-19,:,:,:],x_train[k-18,:,:,:],x_train[k-17,:,:,:],
                            ...
                            x_train[k-13,:,:,:],x_train[k-12,:,:,:],x_train[k-11,:,:,:],
                            x_train[k-10,:,:,:],x_train[k-9,:,:,:],x_train[k-8,:,:,:],
                            x_train[k-7,:,:,:],x_train[k-6,:,:,:],x_train[k-5,:,:,:],
                            x_train[k-4,:,:,:],x_train[k-3,:,:,:],x_train[k-2,:,:,:],
...
def create_model(weight=1e-3):
    model= Sequential()
    model.add(LSTM(19, return_sequences=True,input_shape=(20,360)))
